 ...
 */
 // PrintAnnotation 의 타겟위치를 설정 
@Target(ElementType.METHOD) //annotation이 적용가능한 대상을 지정함
// PrintAnnotation의 유지기간 / @Retention가 없으면 클래스까지만 가능
@Retention(RetentionPolicy.RUNTIME) // 유지기간 지정함.(기본값 : CLASS) // 계속 유지하고 싶으면 RUNTIME사용
public @interface PrintAnnotation {
	int id = 100;  //상수 선언 가능. static final int id = 100;
	String value() default "-"; // 기본값을 '-'로 지정  /default "-" => 있어도되고 없어도됨 
